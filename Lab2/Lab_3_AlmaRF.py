...
# Additional augmentations:
    ...
    augmented_labels = np.concatenate((y_train_classification, np.ones(sum([len(rotated_90), len(rotated_180), len(rotated_270), len(flipped_horizontal), len(flipped_vertical), len(randomly_cropped), len(brightness_adjusted)]))))
